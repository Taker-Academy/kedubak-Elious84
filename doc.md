...
```json
{
    ...
    "data": {
        ...
        "user": {
            ...
            "firstNam# Documentation de l'API, by Stephane
...
- **500 Internal Serv# Documentation de l'API, by Stephane
...
- **id (String, requi# Documentation de l'API, by Stephane
...
```json
{
    ...
    "data": {
        "firstName": "John",
        "content": "C# Documentation de l'API, by Stephane
